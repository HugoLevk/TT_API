...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241212161632_InitMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.TeamMember", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("Domain.Model.Project", b =>
                {
                    b.HasOne("Domain.Model.User", "CreatedBy_User")
                        .WithMany("Projects")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("CreatedBy_User");
                });
